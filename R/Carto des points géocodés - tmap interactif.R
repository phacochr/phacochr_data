...
if ((str_detect(paste(unique(FULL_GEOCODING_sf$Region[!is.na(FULL_GEOCODING_sf$Region)]), collapse = " "), "Bruxelles")) & (length(unique(FULL_GEOCODING_sf$Region[!is.na(FULL_GEOCODING_sf$Region)])) == 1)){
...
# a) Geopackages --------------------------------------------------------------------------------------------------------------------------
  ...
  if (!exists("BXL_communes")){
    BXL_communes <- st_read("Shp/PREPROCESSED/BXL_communes_PREPROCESSED.gpkg")
  }
  if (!exists("BXL_SS")){
    BXL_SS <- st_read("Shp/PREPROCESSED/BXL_SS_PREPROCESSED.gpkg")
  }
  if (!exists("BRUXELLES")){
    BRUXELLES <- st_read("Shp/PREPROCESSED/BRUXELLES_PREPROCESSED.gpkg")
  }
...
# a) Geopackages --------------------------------------------------------------------------------------------------------------------------
  ...
  if (!exists("BE_communes")){
    BE_communes <- st_read("Shp/PREPROCESSED/BE_communes_PREPROCESSED.gpkg")
  }
  if (!exists("BE_provinces")){
    BE_provinces <- st_read("Shp/PREPROCESSED/BE_provinces_PREPROCESSED.gpkg")
  }
  if (!exists("BE_regions")){
    BE_regions <- st_read("Shp/PREPROCESSED/BE_regions_PREPROCESSED.gpkg")
  }
  if (!exists("BELGIQUE")){
    BELGIQUE <- st_read("Shp/PREPROCESSED/BELGIQUE_PREPROCESSED.gpkg")
  }
